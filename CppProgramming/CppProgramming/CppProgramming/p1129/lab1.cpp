...
int main() {
	Building<Protoss>* protossBuilding = new Building<Protoss>();
	Building<Terran>* terranBuilding = new Building<Terran>();
	...
	protossBuilding->buy(&zealot, mineral, gas);
	terranBuilding->buy(&marine, mineral, gas);
